...
export default function FloatingWhatsApp() {
  ...
  return (
    <motion.a
      ...
      className="fixed bottom-16 right-6 z-50 bg-green-500 text-white p-4 rounded-full shadow-lg hover:bg-green-600 transition-colors flex items-center justify-center group"
